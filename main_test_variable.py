...
if __name__ == '__main__':
	...
	for iteration, (ori_data, A, mean_xy, adjacency) in enumerate(pra_data_loader):
		print(iteration, ori_data.shape, A.shape, mean_xy.shape, adjacency.shape)
		adjacency_numpy = adjacency.detach().cpu().numpy()
		adj_all = pra_data_loader.dataset.all_adjacency[0]
# 		A_sq = A_numpy.squeeze()
# 		A_sq0 = A_sq[0]
# 		A_sq1 = A_sq[1]
# 		A_sq2 = A_sq[2]
	...
	# test_model(pra_model, pra_data_loader)
